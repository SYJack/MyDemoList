...
/**
 * author：jack on 2016/3/19 23:34
 */
public class ViewpageToolBar extends LinearLayout {
    ...
    public ViewpageToolBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ViewpageToolBar(Context context) {
        super(context);
    }

    public ViewpageToolBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.ViewpageToolBar);
        mTabVisibleCount = array.getInt(R.styleable.ViewpageToolBar_item_count, COUNT_DEFAULT_TAB);
